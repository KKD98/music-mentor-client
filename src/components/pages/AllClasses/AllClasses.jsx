        ...
        <div className='pt-16'>
            ...
            {classes.map(singleClass =>
                <div  key={singleClass._id} className="card w-full bg-black text-white shadow-xl">
                    <figure><img className='p-5 w-full h-64' src={singleClass.class_image} alt="Shoes" /></figure>
                    <div className="card-body">
                        ...
                        <div className="card-actions justify-center">
                            <button  className="btn bg-rose-700 hover:bg-rose-900 text-white border-none">Select</button>
                        </div>
                    </div>
                </div>
            )}
