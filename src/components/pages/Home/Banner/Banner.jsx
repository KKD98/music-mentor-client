            ...
            <AwesomeSlider>
                <div className='slider-item relative'>
                    ...
                    <div className="mt-8 lg:mt-0 slider-text absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white">
                        ...
                        <button className="btn w-[60%] lg:w-[30%] text-sm md:text-md bg-rose-700 border-none text-white hover:bg-rose-900">Discover More</button>
                    </div>
                </div>
                <div className='slider-item relative'>
                ...
                <div className='slider-item relative'>
                    ...
                    <div className="mt-8 lg:mt-0 slider-text absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white">
                        ...
                        <p  className='my-2 lg:mt-4 lg:mb-6 font-bold text-md lg:text-4xl text-rose-800'>Music Mentor</p>
                        <button className="btn w-[60%] lg:w-[30%] text-sm md:text-md bg-rose-700 border-none text-white hover:bg-rose-900">Discover More</button>
                    </div>
                </div>
            </AwesomeSlider>
